  ...
  return (
    <div className="bg-gradient-to-b from-[var(--color-ivory)] via-[var(--color-cashew-cream)] to-[var(--color-beige)] min-h-screen pt-24 pb-20 relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        <motion.div animate={{ rotate: [0, 10, -10, 0], y: [0, -8, 0] }} transition={{ duration: 10, repeat: Infinity, ease: "linear", delay: 14 }} className="absolute top-5 left-5 opacity-10">
          <AlmondIcon className="w-20 h-20" />
        </motion.div>
        <motion.div animate={{ rotate: [0, -11, 11, 0], x: [0, 8, 0] }} transition={{ duration: 11, repeat: Infinity, ease: "linear", delay: 15 }} className="absolute top-10 right-5 opacity-12">
          <CashewIcon className="w-22 h-22" />
        </motion.div>
        <motion.div animate={{ rotate: [0, 12, -12, 0], y: [0, 10, 0] }} transition={{ duration: 12, repeat: Infinity, ease: "linear", delay: 16 }} className="absolute top-5 left-1/2 opacity-10">
          <PeanutIcon className="w-18 h-18" />
        </motion.div>

        {/* Dense Layer - Middle Section */}
        <motion.div animate={{ rotate: [0, -13, 13, 0], x: [0, -10, 0] }} transition={{ duration: 13, repeat: Infinity, ease: "linear", delay: 17 }} className="absolute top-1/2 left-5 opacity-12">
          <WalnutIcon className="w-20 h-20" />
        </motion.div>
        <motion.div animate={{ rotate: [0, 14, -14, 0], y: [0, -12, 0] }} transition={{ duration: 14, repeat: Infinity, ease: "linear", delay: 18 }} className="absolute top-1/2 right-5 opacity-10">
          <AlmondIcon className="w-24 h-24" />
        </motion.div>
        <motion.div animate={{ rotate: [0, -15, 15, 0], x: [0, 10, 0] }} transition={{ duration: 15, repeat: Infinity, ease: "linear", delay: 19 }} className="absolute top-1/2 left-1/2 opacity-12">
          <CashewIcon className="w-20 h-20" />
        </motion.div>

        {/* Dense Layer - Bottom Section */}
        <motion.div animate={{ rotate: [0, 11, -11, 0], y: [0, 8, 0] }} transition={{ duration: 11, repeat: Infinity, ease: "linear", delay: 20 }} className="absolute bottom-5 left-5 opacity-10">
          <PeanutIcon className="w-22 h-22" />
        </motion.div>
        <motion.div animate={{ rotate: [0, -12, 12, 0], x: [0, -8, 0] }} transition={{ duration: 12, repeat: Infinity, ease: "linear", delay: 21 }} className="absolute bottom-10 right-5 opacity-12">
          <WalnutIcon className="w-24 h-24" />
        </motion.div>
        <motion.div animate={{ rotate: [0, 13, -13, 0], y: [0, -10, 0] }} transition={{ duration: 13, repeat: Infinity, ease: "linear", delay: 22 }} className="absolute bottom-5 left-1/2 opacity-10">
          <AlmondIcon className="w-20 h-20" />
        </motion.div>
