  ...
  return (
    <section id={sectionId} className="py-20 bg-gradient-to-b from-[var(--color-ivory)] to-[var(--color-beige)] relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <motion.div animate={{ rotate: [0, 14, -14, 0], y: [0, 12, 0] }} transition={{ duration: 11, repeat: Infinity, ease: "linear" }} className="absolute top-20 right-20 opacity-15">
          <AlmondIcon className="w-28 h-28" />
        </motion.div>
        <motion.div animate={{ rotate: [0, -12, 12, 0], x: [0, 10, 0] }} transition={{ duration: 13, repeat: Infinity, ease: "linear", delay: 2 }} className="absolute bottom-20 left-20 opacity-15">
        ...
        <motion.div animate={{ rotate: [0, 13, -13, 0], y: [0, -10, 0] }} transition={{ duration: 12, repeat: Infinity, ease: "linear", delay: 4 }} className="absolute bottom-1/3 right-1/4 opacity-15">
          <PeanutIcon className="w-22 h-22" />
        </motion.div>
        <motion.div animate={{ rotate: [0, -12, 12, 0], x: [0, 10, 0] }} transition={{ duration: 13, repeat: Infinity, ease: "linear", delay: 6 }} className="absolute top-1/3 left-1/3 opacity-12">
          <AlmondIcon className="w-26 h-26" />
        </motion.div>
        <motion.div animate={{ rotate: [0, 14, -14, 0], y: [0, 12, 0] }} transition={{ duration: 11, repeat: Infinity, ease: "linear", delay: 7 }} className="absolute bottom-20 left-1/4 opacity-15">
        ...
        <motion.div animate={{ rotate: [0, -11, 11, 0], y: [0, -10, 0] }} transition={{ duration: 11, repeat: Infinity, ease: "linear", delay: 8 }} className="absolute top-5 left-1/4 opacity-10">
          <AlmondIcon className="w-20 h-20" />
        </motion.div>
        <motion.div animate={{ rotate: [0, 12, -12, 0], x: [0, 10, 0] }} transition={{ duration: 12, repeat: Infinity, ease: "linear", delay: 9 }} className="absolute bottom-5 right-1/4 opacity-12">
          <PeanutIcon className="w-22 h-22" />
        </motion.div>
